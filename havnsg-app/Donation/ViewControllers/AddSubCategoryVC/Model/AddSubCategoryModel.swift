...
struct AddSubCategoryModel : Codable {

        let data : AddSubCategoryData?
        let msg : String?
        let success : Bool?
        let error : [Error]?
        ...
        init(from decoder: Decoder) throws {
                ...
                data = try values.decodeIfPresent(AddSubCategoryData.self, forKey: .data)
...
struct AddSubCategoryData : Codable {
