...
//  Donation
//
//  Created by Kanhu Dash on 25/01/22.
//
...
class AboutUsViewController: UIViewController {
    ...
    @IBOutlet weak var lbl_about_title: UILabel!
    ...
    func setUI() {
        self.lbl_AboutUs.text = AboutUs.aboutUs.rawValue
        self.lbl_about_title?.text = AboutUs.aboutTitle.rawValue
        ...
        self.navigationView.lbl_Title.text = PageTite.aboutUs.rawValue
    ...
    @IBAction func btn_EventClicked(sender:UIButton) {
        let nextVC = self.storyboard?.instantiateViewController(withIdentifier: "EventViewController") as! EventViewController
        self.navigationController?.pushViewController(nextVC, animated: true)
    }
}
