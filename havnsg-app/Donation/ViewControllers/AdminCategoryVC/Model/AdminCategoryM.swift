...
struct AdminCategoryM : Codable {

        let data : [AdminCategoryDatum]?
        let msg : String?
        let success : Bool?
        ...
        init(from decoder: Decoder) throws {
                ...
                data = try values.decodeIfPresent([AdminCategoryDatum].self, forKey: .data)
...
struct AdminCategoryDatum : Codable {
...
//                parentCategory = try values.decodeIfPresent(AnyObject.self, forKey: .parentCategory)
        }
