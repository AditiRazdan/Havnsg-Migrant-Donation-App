//
//  DonationRequestVM.swift
//  Donation
//
//  Created by Kanhu Dash on 19/10/21.
//

import Foundation

struct DonationAndReceiveHistorytM : Codable {

        let data : [DonationAndReceiveHistoryDatum]?
        let msg : String?
        let success : Bool?
        ...
        init(from decoder: Decoder) throws {
                ...
                data = try values.decodeIfPresent([DonationAndReceiveHistoryDatum].self, forKey: .data)
...
struct DonationAndReceiveHistoryDatum : Codable {
